...
public interface DynamicArrayInterface<T> {
    ...
    /**
     * The union of two arrays. Combines the elements inside two arrayss: Array A :
     * {1,2,3,4} Array B : {5,6,7} union : {1,2,3,4,5,6,7}
     *
     ...
     * elements of those two arrays. Array A: {1,2,3,4} Array B: {2,4,5,6} Array A
     * intersection Array B: {2,4}
     *
     * @param anotherArray Another dynamic array.
     ...
     * those two arrays. Array A: {1,2,3,4} Array B: {3,4,5} Array A difference
     * Array B: {1,2}
     *
     * @param anotherArray Another dynamic array
