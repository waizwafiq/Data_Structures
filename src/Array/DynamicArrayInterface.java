...
public interface DynamicArrayInterface<T> {
    ...
    /**
     * The union of two arrays. Combines the elements inside two arrayss: temp.Array A :
     * {1,2,3,4} temp.Array B : {5,6,7} union : {1,2,3,4,5,6,7}
     *
    ...
    /**
     * The intersection of two arrays. A new dynamic array that has the common
     * elements of those two arrays. temp.Array A: {1,2,3,4} temp.Array B: {2,4,5,6} temp.Array A
     * intersection temp.Array B: {2,4}
     *
     * @param anotherArray Another dynamic array.
    ...
    /**
     * The difference of two arrays. A new dynamic array that has the differences of
     * those two arrays. temp.Array A: {1,2,3,4} temp.Array B: {3,4,5} temp.Array A difference
     * temp.Array B: {1,2}
     *
     * @param anotherArray Another dynamic array
